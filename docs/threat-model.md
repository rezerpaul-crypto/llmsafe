...
- Cross-language dataflow and Python flows through wildcard/dynamic imports, methods, callable
  objects, runtime import hooks, or modules outside the selected project boundary
